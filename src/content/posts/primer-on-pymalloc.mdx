...
description: "Why deleting half of your small Python objects doesn't free half of your memory: a look at pymalloc arenas and fragmentation."
date: "2023-09-30"
---
...
- [Stack Overflow: Python memory deallocation](https://stackoverflow.com/a/3770572)
- [Python docs: The pymalloc allocator](https://docs.python.org/3/c-api/memory.html#the-pymalloc-allocator)
- [Evan Jones: Improving Python's memory allocator](https://www.evanjones.ca/memoryallocator/)
- [Stack Overflow: Releasing memory in Python](https://stackoverflow.com/a/40663945)

[^1]: [Python docs: The pymalloc allocator](https://docs.python.org/3/c-api/memory.html#the-pymalloc-allocator)
